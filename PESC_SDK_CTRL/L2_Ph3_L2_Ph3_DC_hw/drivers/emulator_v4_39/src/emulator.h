...
#endif
/**
* Write to cpu_in_3 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the cpu_in_3 instance to operate on.
* @param	Data is value to be written to gateway cpu_in_3.
*
* @return	None.
*
* @note    .
*
*/
void emulator_cpu_in_3_write(emulator *InstancePtr, int Data);
/**
* Read from cpu_in_3 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the cpu_in_3 instance to operate on.
*
* @return	int
...
*
*/
int emulator_cpu_in_3_read(emulator *InstancePtr);
/**
* Write to cpu_in_2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the cpu_in_2 instance to operate on.
* @param	Data is value to be written to gateway cpu_in_2.
*
* @return	None.
*
* @note    .
*
*/
void emulator_cpu_in_2_write(emulator *InstancePtr, int Data);
/**
* Read from cpu_in_2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the cpu_in_2 instance to operate on.
*
* @return	int
...
*
*/
int emulator_cpu_in_2_read(emulator *InstancePtr);
/**
* Write to cpu_in_1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the cpu_in_1 instance to operate on.
* @param	Data is value to be written to gateway cpu_in_1.
*
* @return	None.
*
* @note    .
*
*/
void emulator_cpu_in_1_write(emulator *InstancePtr, int Data);
/**
* Read from cpu_in_1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the cpu_in_1 instance to operate on.
*
* @return	int
...
*
*/
int emulator_cpu_in_1_read(emulator *InstancePtr);
/**
...
/**
* Write to current_pu_bit2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the current_pu_bit2 instance to operate on.
* @param	Data is value to be written to gateway current_pu_bit2.
*
* @return	None.
*
* @note    .
*
*/
void emulator_current_pu_bit2_write(emulator *InstancePtr, int Data);
/**
* Read from current_pu_bit2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the current_pu_bit2 instance to operate on.
*
* @return	int
...
*
*/
int emulator_current_pu_bit2_read(emulator *InstancePtr);
/**
* Write to current_pu_bit1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the current_pu_bit1 instance to operate on.
* @param	Data is value to be written to gateway current_pu_bit1.
*
* @return	None.
*
* @note    .
*
*/
void emulator_current_pu_bit1_write(emulator *InstancePtr, int Data);
/**
* Read from current_pu_bit1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the current_pu_bit1 instance to operate on.
*
* @return	int
...
*
*/
int emulator_current_pu_bit1_read(emulator *InstancePtr);
/**
...
/**
* Read from concatstage_ia1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ia1 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ia1_read(emulator *InstancePtr);
/**
* Read from concatstage_ia2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ia2 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ia2_read(emulator *InstancePtr);
/**
* Read from concatstage_ia3 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ia3 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ia3_read(emulator *InstancePtr);
/**
* Read from concatstage_ia5 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ia5 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ia5_read(emulator *InstancePtr);
/**
* Read from concatstage_ia6 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ia6 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ia6_read(emulator *InstancePtr);
/**
* Read from concatstage_ib1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ib1 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ib1_read(emulator *InstancePtr);
/**
* Read from concatstage_ib2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ib2 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ib2_read(emulator *InstancePtr);
/**
* Read from concatstage_ic1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ic1 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ic1_read(emulator *InstancePtr);
/**
* Read from concatstage_ic2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_ic2 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_ic2_read(emulator *InstancePtr);
/**
* Read from concatstage_vdc1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_vdc1 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_vdc1_read(emulator *InstancePtr);
/**
* Read from concatstage_vdc2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the concatstage_vdc2 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_concatstage_vdc2_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_gate_pulses_read(emulator *InstancePtr);
/**
...
/**
* Read from uab gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the uab instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_uab_read(emulator *InstancePtr);
/**
