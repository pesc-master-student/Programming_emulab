...
void emulator_vdc1_write(emulator *InstancePtr, int Data) {
    ...
    emulator_WriteReg(InstancePtr->emulator_BaseAddress, 48, Data);
}
...
void emulator_ts_la_write(emulator *InstancePtr, int Data) {
    ...
    emulator_WriteReg(InstancePtr->emulator_BaseAddress, 52, Data);
}
...
void emulator_ts_tm_write(emulator *InstancePtr, int Data) {
    ...
    emulator_WriteReg(InstancePtr->emulator_BaseAddress, 56, Data);
}
...
void emulator_ts_tf_write(emulator *InstancePtr, int Data) {
    ...
    emulator_WriteReg(InstancePtr->emulator_BaseAddress, 60, Data);
}
...
void emulator_tl_write(emulator *InstancePtr, int Data) {
    ...
    emulator_WriteReg(InstancePtr->emulator_BaseAddress, 64, Data);
}
...
int emulator_concatstage_vdc1_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 104);
    return Data;
}
int emulator_concatstage_vdc2_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 108);
    return Data;
}
u8 emulator_enable_sig_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 112);
    return Data;
}
u32 emulator_gate_pulses_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 116);
    return Data;
}
int emulator_ia_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 120);
    return Data;
}
int emulator_if_x0_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 124);
    return Data;
}
u32 emulator_lega_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 128);
    return Data;
}
int emulator_monitor_dc1_a_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 132);
    return Data;
}
u32 emulator_motor_id_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 136);
    return Data;
}
int emulator_te_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 140);
    return Data;
}
int emulator_ua0_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 144);
    return Data;
}
int emulator_ua1_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 148);
    return Data;
}
int emulator_uab_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 152);
    return Data;
}
u32 emulator_uab1_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 156);
    return Data;
}
int emulator_ub0_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 160);
    return Data;
}
int emulator_ub1_read(emulator *InstancePtr) {
    ...
    Data = emulator_ReadReg(InstancePtr->emulator_BaseAddress, 164);
    return Data;
}
