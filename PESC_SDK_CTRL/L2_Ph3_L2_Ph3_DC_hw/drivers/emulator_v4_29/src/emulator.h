...
/**
* Read from ia1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the ia1 instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_ia1_read(emulator *InstancePtr);
#ifdef __cplusplus
}
#endif
#endif
