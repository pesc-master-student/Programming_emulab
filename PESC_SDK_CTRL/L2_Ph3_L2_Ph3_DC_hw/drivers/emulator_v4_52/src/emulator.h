...
/**
* Write to ena_emu_conv2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the ena_emu_conv2 instance to operate on.
* @param	Data is value to be written to gateway ena_emu_conv2.
*
* @return	None.
*
* @note    .
*
*/
void emulator_ena_emu_conv2_write(emulator *InstancePtr, u32 Data);
/**
* Read from ena_emu_conv2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the ena_emu_conv2 instance to operate on.
*
* @return	u32
...
*
*/
u32 emulator_ena_emu_conv2_read(emulator *InstancePtr);
/**
* Write to ena_emu_conv1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the ena_emu_conv1 instance to operate on.
* @param	Data is value to be written to gateway ena_emu_conv1.
*
* @return	None.
*
* @note    .
*
*/
void emulator_ena_emu_conv1_write(emulator *InstancePtr, u32 Data);
/**
* Read from ena_emu_conv1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the ena_emu_conv1 instance to operate on.
*
* @return	u32
...
*
*/
u32 emulator_ena_emu_conv1_read(emulator *InstancePtr);
/**
