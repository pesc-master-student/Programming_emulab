...
/**
* Write to k_fntstep gateway of emu_dc. Assignments are LSB-justified.
*
...
*
*/
void emu_dc_k_fntstep_write(emu_dc *InstancePtr, int Data);
/**
* Read from k_fntstep gateway of emu_dc. Assignments are LSB-justified.
*
* @param	InstancePtr is the k_fntstep instance to operate on.
*
* @return	int
...
*
*/
int emu_dc_k_fntstep_read(emu_dc *InstancePtr);
/**
...
/**
* Read from theta gateway of emu_dc. Assignments are LSB-justified.
*
...
*
*/
int emu_dc_theta_read(emu_dc *InstancePtr);
#ifdef __cplusplus
}
#endif
#endif
