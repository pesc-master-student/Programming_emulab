...
#endif
/**
* Write to wn gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the wn instance to operate on.
* @param	Data is value to be written to gateway wn.
*
* @return	None.
*
* @note    .
*
*/
void emulator_wn_write(emulator *InstancePtr, int Data);
/**
* Read from wn gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the wn instance to operate on.
*
* @return	int
...
*
*/
int emulator_wn_read(emulator *InstancePtr);
/**
