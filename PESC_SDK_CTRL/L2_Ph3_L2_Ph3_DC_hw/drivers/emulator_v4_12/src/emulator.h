...
*
*/
u32 emulator_concatstage_ia2_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_concatstage_ib1_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_concatstage_ib2_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_concatstage_ic1_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_concatstage_ic2_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_concatstage_vdc2_read(emulator *InstancePtr);
/**
...
*
*/
u32 emulator_concatstage_ia1_read(emulator *InstancePtr);
#ifdef __cplusplus
}
#endif
#endif
