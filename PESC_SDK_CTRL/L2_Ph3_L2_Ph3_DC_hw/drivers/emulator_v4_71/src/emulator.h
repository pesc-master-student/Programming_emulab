...
#endif
/**
* Write to voltage_pu_bit_conv2 gateway of emulator. Assignments are LSB-justified.
*
...
*
*/
void emulator_voltage_pu_bit_conv2_write(emulator *InstancePtr, int Data);
/**
* Read from voltage_pu_bit_conv2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the voltage_pu_bit_conv2 instance to operate on.
*
* @return	int
...
*
*/
int emulator_voltage_pu_bit_conv2_read(emulator *InstancePtr);
/**
* Write to voltage_pu_bit_conv1 gateway of emulator. Assignments are LSB-justified.
*
...
*
*/
void emulator_voltage_pu_bit_conv1_write(emulator *InstancePtr, int Data);
/**
* Read from voltage_pu_bit_conv1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the voltage_pu_bit_conv1 instance to operate on.
*
* @return	int
...
*
*/
int emulator_voltage_pu_bit_conv1_read(emulator *InstancePtr);
/**
...
/**
* Write to k_fntstep gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the k_fntstep instance to operate on.
* @param	Data is value to be written to gateway k_fntstep.
*
* @return	None.
*
* @note    .
*
*/
void emulator_k_fntstep_write(emulator *InstancePtr, int Data);
/**
* Read from k_fntstep gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the k_fntstep instance to operate on.
*
* @return	int
...
*
*/
int emulator_k_fntstep_read(emulator *InstancePtr);
/**
* Write to current_pu_bit_conv2 gateway of emulator. Assignments are LSB-justified.
*
...
*
*/
void emulator_current_pu_bit_conv2_write(emulator *InstancePtr, int Data);
/**
* Read from current_pu_bit_conv2 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the current_pu_bit_conv2 instance to operate on.
*
* @return	int
...
*
*/
int emulator_current_pu_bit_conv2_read(emulator *InstancePtr);
/**
* Write to current_pu_bit_conv1 gateway of emulator. Assignments are LSB-justified.
*
...
*
*/
void emulator_current_pu_bit_conv1_write(emulator *InstancePtr, int Data);
/**
* Read from current_pu_bit_conv1 gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the current_pu_bit_conv1 instance to operate on.
*
* @return	int
...
*
*/
int emulator_current_pu_bit_conv1_read(emulator *InstancePtr);
/**
...
/**
* Read from speed gateway of emulator. Assignments are LSB-justified.
*
...
/**
* Read from theta gateway of emulator. Assignments are LSB-justified.
*
* @param	InstancePtr is the theta instance to operate on.
*
* @return	int
*
* @note    .
*
*/
int emulator_theta_read(emulator *InstancePtr);
#ifdef __cplusplus
}
#endif
#endif
